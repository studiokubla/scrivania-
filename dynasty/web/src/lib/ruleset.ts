...
export const RulesetSchema = z.object({
  ...
  youth: z.object({
    ...
    /** Art. 19 — bonus Dynasty Youth per ampiezza della rosa primavera */
  ...
  competitions: z.object({
    ...
    dynastyCup: z.object({ quarterFinals: millions, semiFinals: millions, final: millions, win: millions }),
    superCup: z.object({ semiFinals: millions, final: millions, win: millions }),
    dynastyYouth: z.object({ prizes: z.array(millions) }),
    /** Art. 20 — premi in euro */
    cash: z.object({
      entryFee: z.number(),
      apertura: z.array(z.number()),
      clausura: z.array(z.number()),
      dynastyCup: z.array(z.number()),
      superCup: z.array(z.number()),
      dynastyYouth: z.array(z.number()),
    }),
  }),
...
export const DEFAULT_RULESET: Ruleset = {
  ...
  competitions: {
    ...
    dynastyCup: { quarterFinals: 5, semiFinals: 7, final: 10, win: 15 },
    superCup: { semiFinals: 3, final: 5, win: 7 },
    dynastyYouth: { prizes: [5, 3, 1] },
    cash: {
      entryFee: 75,
      apertura: [130, 100, 70],
      clausura: [130, 100, 70],

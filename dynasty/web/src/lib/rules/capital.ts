...
/** Bonus Dynasty Youth per ampiezza della rosa primavera (art. 19). */
...
export function competitionPrize(input: {
  kind: "APERTURA" | "CLAUSURA" | "DYNASTY_YOUTH";
  position: number;
  ruleset: Ruleset;
}): Money {

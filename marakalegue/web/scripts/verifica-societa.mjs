...
const manager = await loginAs("manager1@marakalegue.it");
const teamId = sql(`select "teamId" from "User" where email='manager1@marakalegue.it';`);
...
check("i premi sono nel registro", testoRegistro.includes("Premi Marakalegue Apertura"));

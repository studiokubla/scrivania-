...
| --- | --- | --- |
| Commissioner | `info@studiokubla.com` | `marakalegue` |
| Manager | `manager1@marakalegue.it` … `manager10@…` | `marakalegue` |

I nomi dei calciatori del seed sono **inventati di proposito**: i dati veri arrivano
dall'import ufficiale, e una rosa demo con nomi reali e quotazioni finte si confonderebbe
con quella buona.
